...
import com.company1075.Beira.adapters.DDetailsAdapter;
...
public class DiagnosisDetailsActivity extends BaseActivity {
    ...
    private DDetailsAdapter mMyradioAdapter;
    @Override
    ...
    protected void initData() {
        ...
        LinearLayoutManager gridLayoutManager = new LinearLayoutManager(DiagnosisDetailsActivity.this);
        mLuRecyclerView.setLayoutManager(gridLayoutManager);
        mMyradioAdapter = new DDetailsAdapter(DiagnosisDetailsActivity.this);
    ...
    protected void setListener() {
        ...
        mLuRecyclerViewAdapter.setOnItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position) {
                startActivity(new Intent(DiagnosisDetailsActivity.this, DetailsAnalysisActivity.class));
            }
        });
